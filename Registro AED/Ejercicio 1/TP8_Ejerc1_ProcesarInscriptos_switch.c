...
void mostrarUnInscripto() {
	...
	switch (regInscripto.codCateg) {
				case 1: printf("Docente universitario\n");
					break;
				case 2: printf("Docente secundario\n");
					break;
				case 3: printf("Estudiante\n");
					break;
			} 
}
...
void mostrarTotalCategoria() {
	...
	for( i=0; i<MAX; i++ ) {
		printf("Categoria %d - ", i+1 ); 
			switch (i){
				case 0: printf("Docente universitario: ");
					break;
				case 1: printf("Docente secundario: ");
					break;
				case 2: printf("Estudiante: ");
					break;
			}
