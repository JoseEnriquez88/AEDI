/*
-Detectar cu�l es el pa�s con mayor cantidad de usuarios, mostrar por pantalla la cantidad y el
nombre del pa�s al cual pertenece.
	cantUsuariosPais;
	if()
...
-Informar por pantalla la cantidad total de conexiones por d�a en Uruguay.
	if(codPais == 3){
		conexUruguay++;

-Calcular, utilizando una funci�n con paso de par�metro, el porcentaje que representan los
usuarios del plan B�sico respecto del total de planes.
