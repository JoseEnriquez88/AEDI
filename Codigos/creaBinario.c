...
tr_alumno vr_alumno; /*Declaraci�n del registro vr_alumno tipo tr_alumno*/
FILE *vf_alumnos;		 /* Declaraci�n del archivo, puntero a la zona de memoria donde se va a iniciar la transferencia*/
...
void grabarArchivoAlumnos()
{
	...
	{ /*proceso donde se ingresan los datos y se van grabando fisicamente*/
		ingresarDatosAlumno();
